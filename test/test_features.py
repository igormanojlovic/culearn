...
class TestMonthOfYear(TestCase, TestPeriodicEncoder):
    ...
    def _sample_min(self) -> (str, int, float, float):
        return datetime(2000, 1, 1), 0, 0, 1

    def _sample_q1(self) -> (str, int, float, float):
        return datetime(2000, 4, 1), 3, 1, 0

    def _sample_q2(self) -> (str, int, float, float):
        return datetime(2000, 7, 1), 6, 0, -1

    def _sample_q3(self) -> (str, int, float, float):
        return datetime(2000, 10, 1), 9, -1, 0

    def _sample_max(self) -> (str, int, float, float):
        return datetime(2000, 12, 1), 11, -0.5, 0.866025404
...
class TestWeekOfYear(TestCase, TestPeriodicEncoder):
    ...
    def _sample_min(self) -> (str, int, float, float):
        return datetime(2000, 1, 3), 0, 0, 1

    def _sample_q1(self) -> (str, int, float, float):
        return datetime(2000, 4, 3), 13, 1, 0

    def _sample_q2(self) -> (str, int, float, float):
        return datetime(2000, 7, 3), 26, 0, -1

    def _sample_q3(self) -> (str, int, float, float):
        return datetime(2000, 10, 4), 39, -1, 0

    def _sample_max(self) -> (str, int, float, float):
        return datetime(2000, 12, 31), 51, -0.12053668, 0.992708874
...
class TestDayOfWeek(TestCase, TestPeriodicEncoder):
    ...
    def _sample_q1(self) -> (str, int, float, float):
        return datetime(2000, 1, 4), 1, 0.781831482, 0.623489802

    def _sample_q2(self) -> (str, int, float, float):
        return datetime(2000, 1, 6), 3, 0.433883739, -0.900968868

    def _sample_q3(self) -> (str, int, float, float):
        return datetime(2000, 1, 8), 5, -0.974927912, -0.222520934

    def _sample_max(self) -> (str, int, float, float):
        return datetime(2000, 1, 9), 6, -0.781831482, 0.623489802
...
class TestTimeOfDay(TestCase, TestPeriodicEncoder):
    ...
    def _sample_q1(self) -> (str, int, float, float):
        return datetime(2000, 1, 1, 6, 0), 6 * 3600, 1, 0

    def _sample_q2(self) -> (str, int, float, float):
        return datetime(2000, 1, 1, 12, 0), 12 * 3600, 0, -1

    def _sample_q3(self) -> (str, int, float, float):
        return datetime(2000, 1, 1, 18, 0), 18 * 3600, -1, 0

    def _sample_max(self) -> (str, int, float, float):
        return datetime(2000, 1, 1, 23, 59, 59), 24 * 3600 - 1, -0.000072722, 0.999999997
